            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit {{$employees->name}}'s profile</h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                               @include('employees.alert')
                                ...
                                <form class="form-horizontal form-material" action="{{ url('employee/' .$employees->id) }}" method="post">
                                          {!! csrf_field() !!}
                                            @method("PATCH")
                                  <input type="hidden" name="id" id="id" value="{{$employees->id}}" id="id" />
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="name" id="name"
                                                class="form-control p-0 border-0" value="{{$employees->name}}" > </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="address" id="address"
                                                class="form-control p-0 border-0" value="{{$employees->address}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            ...
                                            class="form-control p-0 border-0" value="{{$employees->birthday}}">
                                        </div>
                                    </div>
